...
const CreateCategory = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(error)
            toast.error('somthing went wrong in category input form')
        }
    }
    //get all category
    ...
    return (
        <Layout title={'Create Category - GemStone'}>
                        ...
                        <div className='w-75'>
                            <table className="table">
                                ...
                                <tbody>
                                    ...
                                    <tr key={c._id}>
                                            <td >{c.name}</td>
                                            <td ><button className='btn btn-success ms-2 ' onClick={() => {setVisible(true) ; setUpdatedName(c.name) ; setSelected(c)}}>Edit</button>
